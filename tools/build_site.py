...
border:4px solid var(--purple);border-radius:999px;padding:8px 12px 8px 20px;box-shadow:6px 6px 0 var(--pink)}
...
.cta .cta-logo{display:inline-flex;background:#fff;border:4px solid var(--ink);border-radius:999px;padding:9px 22px;margin-bottom:22px;box-shadow:5px 5px 0 var(--yellow);transform:rotate(-2deg)}
...
.ft-brand .ft-logo{background:#fff;border-radius:999px;padding:10px 18px;display:inline-flex;margin-bottom:16px}
